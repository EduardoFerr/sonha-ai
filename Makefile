...
clean-builder:
	docker rm -f $(CONTAINER_ANDROID) 2>/dev/null || true
...
extract:
	mkdir -p dist
	docker cp sonhai-android:/work/android/app/build/outputs/bundle/release/app-release.aab dist/app-release.aab
	@echo "✅ .aab extraído para ./dist/app-release.aab"
